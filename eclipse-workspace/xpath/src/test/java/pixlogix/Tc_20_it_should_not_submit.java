...
public class Tc_20_it_should_not_submit{
	...
	@Test()
	void Fill_notice_period_with_space_value() throws InterruptedException {
		 WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(25));
	
	driver.findElement(By.xpath("//input[@placeholder='Enter Your Full Name']")).sendKeys(" Enter Your Full Name'");
