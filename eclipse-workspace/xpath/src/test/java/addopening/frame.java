...
public class frame {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 WebDriver driver = new ChromeDriver();
	        ...
	        WebElement associated = driver.findElement(By.xpath("(//span[@class='select2-selection__placeholder'][normalize-space()='Stage'])[1]"));
	        
	        Select final1 = new Select(associated);
	        
	        final1.selectByVisibleText("Wordpress Development");
