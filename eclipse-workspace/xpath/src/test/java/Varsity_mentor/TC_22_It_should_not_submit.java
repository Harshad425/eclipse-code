...
public class TC_22_It_should_not_submit { 
	...
	@Test()
	void Fill_provide_more_with_space () throws InterruptedException {
	...
	role_and_current_company.sendKeys("profession-role-company");
