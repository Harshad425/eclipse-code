...
public class TC_7_It_should_not_submit { 
	...
	@Test()
	void Fill_first_name_with_blank_value() throws InterruptedException {

		
	
		Thread.sleep(5000);
	 driver.findElement(By.xpath("//input[@name='last-name']")).sendKeys("test");
